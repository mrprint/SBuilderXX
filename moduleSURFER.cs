    ...
    static class moduleSURFER
    {
        ...
        internal static void ExportSurfer(ref string FileName)
        {
            ...
            using (StreamWriter file = new StreamWriter(FileName))
            {
                ...
                for (N = 1; N <= loopTo; N++)
                {
                    file.WriteLine(moduleLINES.Lines[N].NoOfPoints.ToString() + BLNSeparator + moduleLINES.Lines[N].Name.Trim());
                ...
                for (N = 1; N <= loopTo2; N++)
                {
                    file.WriteLine((modulePOLYS.Polys[N].NoOfPoints + 1).ToString() + BLNSeparator + modulePOLYS.Polys[N].Name.Trim());
