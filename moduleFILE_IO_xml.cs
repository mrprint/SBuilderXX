        ...
        private static XElement BuildLines()
        {
            ...
            for (int n = 1; n <= moduleLINES.NoOfLines; n++)
            {
                var line = new XElement("Line",
                    ...
                    new XAttribute("color", ArgbFromColor(Color.FromArgb(moduleLINES.Lines[n].ColorArgb)))
                );
        ...
        private static XElement BuildPolys()
        {
            ...
            for (int n = 1; n <= modulePOLYS.NoOfPolys; n++)
            {
                var poly = new XElement("Poly",
                    ...
                    new XAttribute("color", ArgbFromColor(Color.FromArgb(modulePOLYS.Polys[n].ColorArgb)))
                );
        ...
        private static XElement BuildLWCIs()
        {
            ...
            for (int n = 1; n <= moduleCLASSES.NoOfLWCIs; n++)
            {
                lwcis.Add(new XElement("LWCI",
                    new XAttribute("color", ArgbFromColor(Color.FromArgb(moduleCLASSES.LWCIs[n].ColorArgb))),
            ...
            try
            {
                ...
                if (noLines > 0)
                {
                    ...
                    foreach (XElement le in linesEl.Elements("Line"))
                    {
                        ...
                        moduleLINES.Lines[n].ColorArgb = ColorFromArgb(XsAttr(le, "color")).ToArgb();
                ...
                if (noPolys > 0)
                {
                    ...
                    foreach (XElement pe in polysEl.Elements("Poly"))
                    {
                        ...
                        modulePOLYS.Polys[n].ColorArgb = ColorFromArgb(XsAttr(pe, "color")).ToArgb();
                ...
                if (noLWCIs > 0)
                {
                    ...
                    foreach (XElement e in lwcisEl.Elements("LWCI"))
                    {
                        ...
                        moduleCLASSES.LWCIs[n].ColorArgb = ColorFromArgb(XsAttr(e, "color")).ToArgb();
                        n++;
                    }
                    SetLWCIs();
                }
